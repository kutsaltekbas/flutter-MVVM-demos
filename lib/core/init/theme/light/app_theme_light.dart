...
import 'package:parolla_game_mvvm/core/init/theme/app_theme.dart';
import 'package:parolla_game_mvvm/core/init/theme/light/color_scheme_light.dart';

import 'light_theme_if.dart';
...
class AppThemeLight extends AppTheme with ILightTheme {
  ...
  ColorScheme get _appColorScheme {
    return ColorScheme(
        primary: colorSchemaLight!.grey,
        primaryVariant: Colors.white, //xx
        secondary: Colors.green,
        secondaryVariant: colorSchemaLight!.darkGreen,
        surface: Colors.blue, //xx
        background: Colors.white, //xx
